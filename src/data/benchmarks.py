...
def get_humaneval(num_proc=10, return_torch=False):
    """
...
def get_gsm8k(num_proc=10, return_torch=False):
    """
...
def get_arc_challenge(num_proc=10, return_torch=False):
    """
    Load and process the AI2-ARC dataset.
    Tokenize the text and store it in binary format for efficient loading.
    """
...
def get_hellaswag(num_proc=10, return_torch=False):
    """
...
def get_logiqa(num_proc=10, return_torch=False):
    """
...
def get_piqa(num_proc=10, return_torch=False):
    """
...
def get_sciq(num_proc=10, return_torch=False):
    """
