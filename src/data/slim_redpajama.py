...
def get_slim_redpajama(subset='arxiv', num_proc=40,
                       return_torch=False,):
    ...
    # }
    # SLIM_DATA_PATH = "/scratch/homes/pagliard/curriculum/src/data/datasets/slim_redpajama"
    # SLIM_DATA_PATH = "/scratch/homes/sfan/doge/src/data/datasets/slim_6b"
    SLIM_DATA_PATH = os.path.join(os.path.dirname(__file__), "datasets/slimpajama/")
...
def get_slim_redpajama_6b(subset='arxiv', num_proc=40,
                          return_torch=False):
    """ Full: https://huggingface.co/datasets/cerebras/SlimPajama-627B
        6B-subset: DKYoon/SlimPajama-6B
    """
    ...
    REDPAJIMA_DATA_PATH = "/scratch/homes/sfan/doge/src/data/datasets/slim_6b"
...
for s in SUBSET2META.keys():
    get_slim_redpajama(subset=s)